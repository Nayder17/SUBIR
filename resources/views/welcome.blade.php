  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">LISTA DE PELICULAS DISPONIBLES</h1>
        <p class="lead text-body-secondary">Lo mejor de lo mejor, al alcance de tus manos</p>
        <p>
    ...
    <div class="container">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          ...
          <img src="{{$peli->postergit}}" alt="Italian Trulli">
            <div class="card-body">
              <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">Ver más</button>
                  <p class="text-body-secondary ms-3">{{$peli->genero}}</p>
                </div>
                <small class="text-body-secondary">{{$peli->año}}</small>
              </div>
            </div>
          </div>
        </div>
